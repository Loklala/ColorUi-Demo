	...
	<view  class="content">
		...
		<view class="cu-list menu" :class="[menuBorder?'':'',1?'card-menu margin-top':'']" style="border-radius:4upx ;">
			...
			<view class="cu-item" :class="menuArrow?'arrow':''">
				...
				<text class=" content" >
					<input type="password" class="text-black" name="paypassword" placeholder="请输入新密码" :value="paypassword" maxlength="19"/>
				</text>
			</view>
			<view class="cu-item" :class="menuArrow?'arrow':''">
				<text class=' text-blue icon-title margin-right-sm'></text>
				<text class="title2">手机号：</text>
				<text class=" content" >
